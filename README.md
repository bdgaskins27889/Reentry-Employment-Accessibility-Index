...
Which North Carolina counties exhibit the highest and lowest levels of structural employment accessibility for returning citizens?
Which structural factors contribute most significantly to disparities in employment accessibility across counties?
Are there observable regional patterns in employment accessibility across urban, suburban, and rural counties?
How sensitive are county rankings to changes in index weighting and component selection?
How does the REAI correlate with broader economic indicators such as unemployment and poverty rates?
REAI Components
...
See docs/datasets_documentation.md for detailed information.
...
Violence Prevention: Employment programs for at-risk youth reduce violent-crime arrests by 33-43% (Heller et al., 2017)
...
Phone: 252.495.3173
LinkedIn: linkedin.com/in/barbaradgaskins
Acknowledgments
...
Heller, S. B., Pollack, H. A., Ander, R., & Ludwig, J. (2017). Preventing youth violence and dropout: A randomized field experiment. Quarterly Journal of Economics, 132(2), 761–802. https://doi.org/10.1093/qje/qjw033

Institute for Justice. (2022). License to Work: A national study of burdens from occupational licensing (3rd ed.). https://ij.org/report/license-to-work-3/

National Conference of State Legislatures. (2023). Ban-the-Box and fair chance hiring laws. https://www.ncsl.org/civil-and-criminal-justice/ban-the-box

Berger-Gross, A. (2022). The Impact of Post-Release Employment on Recidivism in North Carolina. NC Department of Commerce. https://tools.nccareers.org/cfs/reports/Impact_of_post_release_employment_on_recidivism_2022.01.14.pdf

U.S. Census Bureau. (2023). American Community Survey 5-year estimates. https://www.census.gov/data/developers/data-sets/acs-5year.html
